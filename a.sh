...
install_desktop() {
    ...
    case "$desktop" in
        ...
        kde)
            ...
            ;;
        cosmic)
            sudo pacman -S --noconfirm cosmic-session cosmic-terminal cosmic-files cosmic-monitor cosmic-store cosmic-text-editor cosmic-player cosmic-wallpapers xdg-desktop-portal-gtk xdg-user-dirs  cosmic-text-editor  cosmic-text-editor  cosmic-text-editor
