...
install_base_packages() {
    sudo pacman -S --noconfirm git 7zip aria2 gstreamer ffmpeg flatpak tealdeer fastfetch msedit gamemode fwupd arch-update
}
...
install_desktop() {
    ...
    case "$desktop" in
        gnome)
            sudo pacman -S --noconfirm gnome-initial-setup gnome-console gnome-system-monitor gnome-disk-utility baobab gnome-software gnome-text-editor loupe showtime gnome-backgrounds
